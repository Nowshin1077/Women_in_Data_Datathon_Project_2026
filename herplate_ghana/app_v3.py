...
with c1:
    ...
    <div class='detail-card'>
        ...
        <p style='font-size:0.88rem; color:#1F2937;'>Long-term infrastructure investment & dairy cold-chain subsidies.</p>
    </div>
    """, unsafe_allow_html=True)
...
with c2:
    ...
    <div class='detail-card'>
        ...
        <p class='break-point'>❌ Where It Breaks:</p>
        <p style='font-size:0.88rem; color:#4B5563;'>Upstream Agricultural Supply. Prices are affordable, but production is shrinking.</p>
        <p class='solution-point'>💡 Targeted Solution:</p>
        <p style='font-size:0.88rem; color:#1F2937;'>Legume seed subsidies & drought-resilient cowpea farming support.</p>
    </div>
    """, unsafe_allow_html=True)
...
with c3:
    ...
    <div class='detail-card'>
        ...
        <p class='solution-point'>💡 Targeted Solution:</p>
        <p style='font-size:0.88rem; color:#1F2937;'>Direct vouchers for pregnant women & local market distribution networks.</p>
    </div>
    """, unsafe_allow_html=True)
...
with c4:
    ...
    <div class='detail-card'>
        ...
        <p class='break-point'>❌ Where It Breaks:</p>
        <p style='font-size:0.88rem; color:#4B5563;'>Impending Upstream Risk. Consumption is currently higher, but supply is crashing.</p>
        <p class='solution-point'>💡 Targeted Solution:</p>
        <p style='font-size:0.88rem; color:#1F2937;'>Preventative agricultural support for leafy greens (*Kontomire*) & irrigation.</p>
    </div>
    """, unsafe_allow_html=True)
